...
- Installation instructions --> [Click here](/ROpenCVLite/articles/install.html)
- Using [`ROpenCVLite`](https://github.com/swarm-lab/ROpenCVLite) to develop
packages --> [Click here](/ROpenCVLite/articles/usage.html)
